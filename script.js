document.addEventListener('DOMContentLoaded', function () {
  ...
  const animatableElements = document.querySelectorAll(
    '.fade-in, .animate-on-scroll, [data-animate], ' + '.' + OBSERVED_CLASS
  );
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "עמותת אמא בישראל משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6ae9db65-6b52-4b92-9e8a-0ffbf07bdd3b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6ae9db65-6b52-4b92-9e8a-0ffbf07bdd3b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6ae9db65-6b52-4b92-9e8a-0ffbf07bdd3b';
